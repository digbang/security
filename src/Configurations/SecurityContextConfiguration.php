 ...
 * @method SecurityContextConfiguration enableRoles()
 * @method SecurityContextConfiguration enablePermissions()
 * @method SecurityContextConfiguration disableRoles()
 * @method SecurityContextConfiguration disablePermissions()
 * @method SecurityContextConfiguration setGlobalThrottleInterval($interval)
 * @method SecurityContextConfiguration setGlobalThrottleThresholds($thresholds)
 * @method SecurityContextConfiguration setIpThrottleInterval($interval)
 * @method SecurityContextConfiguration setIpThrottleThresholds($thresholds)
 * @method SecurityContextConfiguration setUserThrottleInterval($interval)
 * @method SecurityContextConfiguration setUserThrottleThresholds($thresholds)
 ...
 * @method SecurityContextConfiguration setRemindersExpiration(int $expiration)
 * @method SecurityContextConfiguration setRemindersLottery(array $lottery)
 * @method SecurityContextConfiguration setActivationsExpiration(int $expiration)
 * @method SecurityContextConfiguration setActivationsLottery(array $lottery)
 ...
 * @method SecurityContextConfiguration setRolePermissionTable(string $table)
 * @method SecurityContextConfiguration setActivationTable(string $table)
 * @method SecurityContextConfiguration setPersistenceTable(string $table)
 * @method SecurityContextConfiguration setReminderTable(string $table)
 * @method SecurityContextConfiguration setRoleTable(string $table)
 * @method SecurityContextConfiguration setThrottleTable(string $table)
