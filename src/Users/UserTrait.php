...
use Cartalyst\Sentinel\Users as Exceptions;
...
trait UserTrait
{
	...
	public function validate()
	{
		if (! $this->email)
		{
			throw new \InvalidArgumentException("A login is required for a user, none given.");
		}

		if (! $this->getPassword())
		{
			throw new \InvalidArgumentException("A password is required for user [$this->email], none given.");
		}
	...
	public function attemptActivation($activationCode)
	{
		if ($this->isActivated())
		{
			throw new \InvalidArgumentException("User already activated.");
		}
