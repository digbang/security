...
class ConfigurationRepositoryFactorySpec extends ObjectBehavior
{
	...
	function it_shouldnt_make_role_repositories_when_they_are_disabled(SecurityContextConfiguration $config, RepositoryFactory $defaults)
	{
	...
	function it_shouldnt_make_permission_repositories_when_they_are_disabled(SecurityContextConfiguration $config, RepositoryFactory $defaults)
	{
	...
	function it_should_make_persistence_repositories(SecurityContextConfiguration $config, PersistenceRepository $persistenceRepository)
	{
	...
	function it_should_make_activation_repositories(SecurityContextConfiguration $config, ActivationRepository $activationRepository)
	{
	...
	function it_should_make_reminder_repositories(UserRepository $users, SecurityContextConfiguration $config, ReminderRepository $reminderRepository)
	{
	...
	function it_should_make_throttle_repositories(SecurityContextConfiguration $config, ThrottleRepository $throttleRepository)
	{
