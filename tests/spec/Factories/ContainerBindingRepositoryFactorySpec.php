...
class ContainerBindingRepositoryFactorySpec extends ObjectBehavior
{
    ...
    public function it_should_make_user_repositories(PersistenceRepository $persistences, Container $container, RoleRepository $roles)
    {
    ...
    public function it_should_make_role_repositories(Container $container)
    {
    ...
    public function it_should_make_permission_repositories(Container $container)
    {
    ...
    public function it_should_make_persistence_repositories(Container $container)
    {
    ...
    public function it_should_make_activation_repositories(Container $container)
    {
    ...
    public function it_should_make_reminder_repositories(UserRepository $users, Container $container)
    {
    ...
    public function it_should_make_throttle_repositories(Container $container)
    {
