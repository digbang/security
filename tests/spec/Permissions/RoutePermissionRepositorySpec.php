...
class RoutePermissionRepositorySpec extends ObjectBehavior
{
    ...
    public function it_is_a_permissions_repository_instance()
    {
        $this->shouldHaveType(PermissionRepository::class);
    }

    public function it_should_return_a_valid_permission_for_a_valid_route(Router $router, RouteCollection $routeCollection)
    {
    ...
    public function it_should_return_a_valid_permission_for_a_valid_action(Router $router, RouteCollection $routeCollection)
    {
        $router->getRoutes()->shouldBeCalled();
    ...
    public function it_should_return_null_for_an_invalid_route(Router $router, RouteCollection $routeCollection)
    {
        $router->getRoutes()->shouldBeCalled();
    ...
    public function it_should_return_null_for_an_invalid_action(Router $router, RouteCollection $routeCollection)
    {
        $router->getRoutes()->shouldBeCalled();
    ...
    public function it_should_return_all_permissions(Router $router, RouteCollection $routeCollection, Route $route)
    {
        $router->getRoutes()->shouldBeCalled();
