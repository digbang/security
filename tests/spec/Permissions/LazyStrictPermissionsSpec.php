...
class LazyStrictPermissionsSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType('Digbang\Security\Permissions\LazyStrictPermissions');
    }
    ...
    public function it_doesnt_override_denied_role_permissions(User $user, Role $role)
    {
        $user = $user->getWrappedObject();
        $role = $role->getWrappedObject();
        $permissions = [
