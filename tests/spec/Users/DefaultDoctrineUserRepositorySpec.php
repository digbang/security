...
class DefaultDoctrineUserRepositorySpec extends ObjectBehavior
{
	...
	function it_should_return_null_when_user_by_id_doesnt_find_anything(EntityManager $entityManager)
	{
	...
	function it_should_find_users_by_login(EntityManager $entityManager, DefaultUser $user, QueryBuilder $queryBuilder)
	{
	...
	function it_should_find_users_by_email(EntityManager $entityManager, DefaultUser $user, QueryBuilder $queryBuilder)
	{
		$this->prepareQuery($entityManager, $queryBuilder, $user->getWrappedObject());
	...
	function it_should_find_users_by_username(EntityManager $entityManager, DefaultUser $user, QueryBuilder $queryBuilder)
	{
		$this->prepareQuery($entityManager, $queryBuilder, $user->getWrappedObject());
	...
	function it_should_fail_when_no_login_email_or_username_is_given(EntityManager $entityManager, QueryBuilder $queryBuilder)
	{
	...
	function it_should_find_users_by_persistence_code(PersistenceRepositoryInterface $persistenceRepository)
	{
	...
	function it_should_record_logins_and_persist_them(EntityManager $entityManager, User $user)
	{
	...
	function it_should_record_logouts_and_persist_them(EntityManager $entityManager, User $user)
	{
		$entityManager->persist($user)->shouldBeCalled();
		$entityManager->flush(Argument::cetera())->shouldBeCalled();
	...
	function it_should_validate_a_users_credentials(User $user)
	{
	...
	function it_should_invalidate_a_users_credentials(User $user)
	{
	...
	function it_should_check_credentials_needed_for_creation()
	{
	...
	function it_should_check_credentials_needed_for_update(User $user)
	{
	...
	function it_should_create_users(EntityManager $entityManager)
	{
