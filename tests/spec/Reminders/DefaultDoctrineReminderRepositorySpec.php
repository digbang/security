...
{
    public function let(EntityManager $entityManager, ClassMetadata $classMetadata, UserRepository $userRepository)
    {
    ...
    public function it_implements_sentinels_reminder_repository_interface()
    {
        $this->shouldHaveType(ReminderRepositoryInterface::class);
        $this->shouldHaveType(ReminderRepository::class);
    }

    public function it_should_check_if_a_reminder_exists_for_a_given_user(User $user, EntityManager $entityManager, QueryBuilder $queryBuilder, AbstractQuery $query, Reminder $reminder)
    {
    ...
    public function it_should_check_if_a_reminder_exists_for_a_given_user_and_code(User $user, EntityManager $entityManager, QueryBuilder $queryBuilder, AbstractQuery $query, Reminder $reminder)
    {
        $this->prepareFindIncompleteQuery($entityManager, $queryBuilder, $query, $reminder);
    ...
    public function it_shouldnt_explode_if_a_reminder_does_not_exist_for_a_given_user(User $user, EntityManager $entityManager, QueryBuilder $queryBuilder, AbstractQuery $query, Reminder $reminder)
    {
    ...
    public function it_should_complete_an_existing_reminder(User $user, EntityManager $entityManager, QueryBuilder $queryBuilder, AbstractQuery $query, Reminder $reminder, UserRepositoryInterface $userRepository)
    {
        $this->prepareFindIncompleteQuery($entityManager, $queryBuilder, $query, $reminder);
    ...
    public function it_should_fail_to_complete_an_expired_reminder(User $user, EntityManager $entityManager, QueryBuilder $queryBuilder, AbstractQuery $query, UserRepositoryInterface $userRepository)
    {
        $this->prepareFindIncompleteQuery($entityManager, $queryBuilder, $query);
    ...
    public function it_should_remove_expired_reminders(EntityManager $entityManager, QueryBuilder $queryBuilder, AbstractQuery $query)
    {
